<!--
Espelhado para o Grimório de Agentes de Negócio · a Guilda · @cigano.agi.
Fonte: github.com/msitarzewski/agency-agents/blob/main/marketing/marketing-video-optimization-specialist.md (Licença MIT).
Curadoria, posicionamento e voz: Fabricio Feitosa. Conteúdo do prompt: msitarzewski/agency-agents.
-->
